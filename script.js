var productList = [
    {
      "id": "1",
      name: "Men Navy Blue Solid Sweat shirt",
    ...
    {
      "id": "5",
      name: "Women BlueSolid Shirt Dress",
  ...
  for(let eachCard of productList){
    
    
   
      
    
    if(eachCard.isAccessory == false){
      ...
      img.setAttribute("src", eachCard.preview)
      ...
      brand.innerHTML = eachCard.brand
  
      infoDiv.appendChild(brand)
  
      var priceTag = document.createElement("h5")
  
      priceTag.innerHTML = eachCard.price
      ...
      else if(eachCard.isAccessory==true){
      
      
      
   var cardWrapper1 = document.getElementById("card-wrapper1")
    
  var cardDiv1 = document.createElement("div")
   
  cardDiv1.id = "card1"
  
  cardWrapper1.appendChild(cardDiv1)
  
  var img1 = document.createElement("img")
  
  img1.setAttribute("src", eachCard.preview)
  ...
  title1.innerHTML = eachCard.name
  
  infoDiv1.appendChild(title1)
  
  var brand1 = document.createElement("h4")
  brand1.innerHTML = eachCard.brand
  
  infoDiv1.appendChild(brand1)
  
  var priceTag1 = document.createElement("h5")
  
  priceTag1.innerHTML = eachCard.price
  
  infoDiv1.appendChild(priceTag1)
